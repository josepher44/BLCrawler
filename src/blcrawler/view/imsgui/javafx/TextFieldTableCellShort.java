 ...
 * @since JavaFX 2.2
 */
public class TextFieldTableCellShort<S,T> extends TextFieldTableCell<S,T> {
    ...
    public static <S,T> Callback<TableColumn<S,T>, TableCell<S,T>> forTableColumn(
        ...
        return list -> new TextFieldTableCellShort<S,T>(converter);
    }
     ...
     */
    public TextFieldTableCellShort() {
        this(null);
    }
     ...
     *      type T.
     */
    public TextFieldTableCellShort(StringConverter<T> converter) {
    ...
    private void createTextField() {
        ...
        textField.setOnAction(evt -> {
            if(textField.getText() != null && !textField.getText().isEmpty()){
            	//Ignore unchecked cast; in normal use, T should always be Short
                commitEdit((T) Short.valueOf(textField.getText()));
            }
        });
